...
Acquisition funtion|采集函数  
Actor-critic method|行为-评判方法  
Adaptive bitrate (ABR) algorithm|自适应比特率算法  
Adaptive Resonance Theory/ART|自适应谐振理论  
Addictive model|加性模型  
...
Application-speciﬁc integrated circuit|专用集成电路  
...
Asynchoronous Stochastic Gradient Descent|异步随机梯度下降  
